      ...
      <div class="row">
        <div class="col-5 py-1">
          <div class="row">
            ...
            <div class="col-12 py-1">
              <span class="main_green_blue_color h5"><b class="main_sky_blue_color">Invoice No:&nbsp;</b>{{$invoice->invoice_no}}</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-7 py-1">
          <div class="row">
            ...
            <div class="col-12 py-1">
              <span class="main_green_blue_color h5"><b class="main_sky_blue_color">Issued & Valid only on:&nbsp;</b>{{date('F jS, Y', strtotime($invoice->date_of_payment))}}</span>
            </div>
    
            <div class="col-12 py-1">
              <span class="main_green_blue_color h5"><b class="main_sky_blue_color">Due:&nbsp;</b>{{date('F jS, Y', strtotime($invoice->date_of_payment))}}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 mt-2 p-2">
      ...
      <div class="row">
        ...
        @foreach ($receipts as $receipt)
          ...
          @php
            if($receipt->accountability_type == 2){
              if($receipt->borrowed_book_status == 10){
                ...
                $total_price += $receipt->payment_price;
          ...
          <div class="col-3">
            @if ($receipt->accountability_type == 2)
              <span class="main_green_blue_color">&#8369;{{$receipt->payment_price}}</span>
