          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <calendar-borrow 
                  url_form="{{route('admin.borrowing.reserve_book')}}" 
                  csrf="{{ csrf_token() }}" 
                  count_accessions='{{$count}}' 
                  accession_id='{{$book->accession_id}}' 
                  :no_accessions='@json($no_accessions)' 
                  :students='@json($all_users['students'])' 
                  :coaches='@json($all_users['staff_coach'])' 
                />
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          ...
          <div class="form-row mt-2">
            <div class="form-group col offset-md-1">
              <a href="{{route('admin.borrowing.borrow_book')}}" class="btn btn-primary">
