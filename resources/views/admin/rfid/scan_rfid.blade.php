        ...
        <div class="mx-1 mt-5 p-5 card bg-white box_form text-center">
          ...
          <div class="row">
            <div class="col-12 my-5">
              <h1 class="display-1 font-weight-bold text-info">Scan RFID <i class="far fa-address-card"></i></h1>
            ...
            <div class="col-12 mb-5 px-5 text-center">
              <form action="{{route('admin.rfid.check_rfid')}}" method="post">
                @csrf
            ...
            <div class="col-12 mb-5 px-5 text-center">
              <a class="btn btn-lg btn-secondary font-weight-bold mx-1" href="{{route('admin.rfid.all_users') . '/' . $type}}"><i class="fas fa-arrow-circle-left"></i> Back</a>
              <a class="btn btn-lg btn-primary font-weight-bold mx-1" href="{{route('admin.rfid.scan_rfid') . '/' . $type}}">Refresh <i class="fas fa-sync-alt"></i></a>
            </div>
          </div>
        </div>
      </div>
