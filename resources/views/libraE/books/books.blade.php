...
@section('content')
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      <form action="{{route('libraE.books.search_book')}}" id="search_form">
      ...
      <div class="col-12 p-5">
        ...
        <div class="row mt-2 mb-4">
          <div class="col-auto offset-md-1 my-1">
            <a href="{{route('libraE.reservations.books')}}">
          ...
          <div class="col-auto my-1">
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="per_page_btn">
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 5}}">5</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 10}}">10</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 20}}">20</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 50}}">50</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 100}}">100</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 200}}">200</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_per_page') . '/' . 500}}">500</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-auto my-1">
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="per_page_btn">
                <a class="dropdown-item" href="{{route('libraE.books.available_books_toOrder') . '/' . 'book_title'}}">Title</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_toOrder') . '/' . 'author_name'}}">Author</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_toOrder') . '/' . 'publisher_name'}}">Publisher</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_toOrder') . '/' . 'copyright'}}">Copyright</a>
                <a class="dropdown-item" href="{{route('libraE.books.available_books_toOrder') . '/' . 'created_at'}}">Date Added</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-auto my-1">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="per_page_btn">
                  <a class="dropdown-item" href="{{route('libraE.books.available_books_orderBy') . '/' . 'asc'}}">Ascending</a>
                  <a class="dropdown-item" href="{{route('libraE.books.available_books_orderBy') . '/' . 'desc'}}">Descending</a>
                </div>
              </div>
            </div>
        </div>
            ...
            @foreach ($all_books as $book)
              <div class="col-md-4 mb-5">
                <div class="card shadow_card_book">
                  ...
                  <div class="card-body">
                    <a href="{{route('libraE.books.view_book') . '/' . $book->accession_id}}" class="card-link btn btn-success btn-sm m-1">
